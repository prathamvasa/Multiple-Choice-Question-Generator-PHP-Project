...
$sql2="SELECT Quiz_level from quiz_category where Quiz_level='".($row<9.0?1:($row<18.0?2:3))."'";



$res2=mysql_fetch_array(mysql_query($sql2,$con));$res2=$res2[0];

unset($row);
// Specify the query to execute
$sql = "SELECT * from question_master where Quiz_Id='".$res2."' and Semester='".$Semester."' and Subject_Id='".$Subject_Id."' ORDER BY RAND() LIMIT 0,10";
